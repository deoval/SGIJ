	...
	jQuery.fn.ddBarChart = function(options) {
		...
		function buildXAxis (objSettings, strID) {
			...
			for (intLabels = 0; intLabels < objSettings.chartData.DATA.length; intLabels++) {
				$(strID + " > .ddchart-x-axis-wrapper > .ddchart-x-axis-wrapper-sub").append('<div class="ddchart-x-axis" style="left:'+intBarWidth*intLabels+'%; width:'+intBarWidth+'%;"><div class="x-axis-text" title="' + objSettings.chartData.DATA[intLabels][objSettings.chartData.COLUMNS.indexOf('X_BAR_VALUE')] + '" style="display:inline" title="'+objSettings.chartData.DATA[intLabels][objSettings.chartData.COLUMNS.indexOf('X_BAR_LABEL')]+'">'+objSettings.chartData.DATA[intLabels][objSettings.chartData.COLUMNS.indexOf('X_BAR_LABEL')]+'</div></div>');
			}
		...
		function buildChart (objSettings, strID, intYMax) {
			...
			for (intBars = 0; intBars < objSettings.chartData.DATA.length; intBars++) {
				...
				$(strID + " > .ddchart-chart-final > .ddchart-chart-wrapper-sub").append('<div class="'+objSettings.chartBarClass+' ddchart-chart" '+strToolTipTitle+strDrillLink+strURLLink+' barlabel="'+objSettings.chartData.DATA[intBars][objSettings.chartData.COLUMNS.indexOf('X_BAR_LABEL')]+'" style="left:'+((intBarWidth*intBars)+(intMargin/2))+'%; height:'+((objSettings.chartData.DATA[intBars][objSettings.chartData.COLUMNS.indexOf('X_BAR_VALUE')]/intYMax)*100)+'%; width:'+(intBarWidth-intMargin)+'%;'+strBGColor+'" chartParentID="'+strID+'">&nbsp;</div>');
