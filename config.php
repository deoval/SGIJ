...
define('EMPRESA_NOME', 'Sistema de Gestão de Informação Jurídica ');
...
define('CREATE', 'Salvar');
define('LOGIN', 'Login');
define('BACK', 'Voltar');
define('CREATELBL','Novo');
define('UPDATELBL','Atualizar');
define('ADMINLBL','Consultar');
define('DELETELBL','Exclusão');
define('VIEWLBL','Visualizar');
...
define('TBL_PRAZOS', 'prazos_do_processo');
