Raphael.fn.pieChart = function (cx, cy, r, values, labels, stroke) {
    ...
    var angle = 0,
	    ...
	    $("table tr:nth-child(" + (j+1) +") th").css({"color": bcolor, "font-size": 14});
            p.mouseover(function () {
                p.stop().animate({transform: "s1.0 1.0 " + cx + " " + cy}, ms, "fadeIn");
                txt.stop().animate({opacity: 1}, ms, "fadeIn");
            }).mouseout(function () {
                p.stop().animate({transform: ""}, ms, "fadeIn");
