    ...
    <body>
        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container"><img src="logo.php"> 
                    <?php
                    ...
                    <div class="navbar-form pull-right">
                        <span style="line-height:40px;color:#FFF;text-transform:capitalize"><?php print $sys_user_name; ?> <?php print $sys_user_cargo; ?></span>  
                        <a style="line-height:40px;color:#FFF;text-transform:capitalize" href="index.php?r=<?php print $link_login_logout; ?>"><?php print $link_login_logout; ?></a></div>
                            ...
                            <?php if (isset($_SESSION['user']) && in_array('usuario', $nav[$_SESSION['user']['cargo']])) { ?>
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="divider"></li>  
                                        <li><a href="index.php?r=usuario/admin">Gerenciar Usuarios</a></li>
                            ...
                            <?php if (isset($_SESSION['user']) && in_array('cliente', $nav[$_SESSION['user']['cargo']])) { ?>
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="divider"></li>
                                        <li><a href="index.php?r=cliente/admin">Gerenciar Clientes</a></li>
                                    </ul>
                                </li>
                            <?php } ?>
                            <?php if (isset($_SESSION['user']) && in_array('processo', $nav[$_SESSION['user']['cargo']])) { ?>  
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="divider"></li>  
                                        <li><a href="index.php?r=processo/admin">Gerenciar Processos</a></li>
                            ...
                            <?php if (isset($_SESSION['user']) && in_array('tarefa', $nav[$_SESSION['user']['cargo']])) { ?>  
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="divider"></li>  
                                        <li><a href="index.php?r=tarefa/admin">Gerenciar Tarefas</a></li>
                            ...
                            <?php if (isset($_SESSION['user']) && in_array('prazo', $nav[$_SESSION['user']['cargo']])) { ?>  
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="divider"></li>  
                                        <li><a href="index.php?r=prazo/admin">Gerenciar Prazos</a></li>
                            ...
                            <?php if (isset($_SESSION['user']) && in_array('pagamento', $nav[$_SESSION['user']['cargo']])) { ?>  
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="divider"></li>  
                                        <li><a href="index.php?r=pagamentos/admin">Gerenciar Pagamentos</a></li>
