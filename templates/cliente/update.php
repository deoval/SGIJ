...
foreach ($campos_da_tabela as $key => $campos) {
    ...
    if (empty($dropdown[$campos])) {
        print "<input type='text' class='input-block-level' id='$campos' name='$campos' title='" . $key . "' placeholder='" . $key . "' value=\"" . $dados[0][$campos] . "\"><br />";
    } else {
...
#cidade{width:300px;}
#estado{width:300px;}
#numero_telefone,#telefone,#telefone_celular{width:300px;}
