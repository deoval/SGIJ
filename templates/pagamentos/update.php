...
if (empty($dropdown[$campo])) {
        ...
        print "<br /><input type='text' class='input-block-level' title='$key' id='$campo' name='$campo' placeholder='" . $key . "' value=\"" . $value . "\">";
}else{
 $dados_campo_select = "";
            $dados_caixa_campos = "";
    ...
    ?><div>
    <input type="submit" id="update-btn" class="btn btn-large btn-primary" value="<?php print UPDATE; ?>"></input></div>
</form>
<script>
